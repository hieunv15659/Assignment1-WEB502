	...
	render: () => {
		...
		return (
			...
			<div  class="flex bg-blue-300  ">
                <div class="  justify-between mx-8">
				...
				<button type="submit" class="p-2.5 ml-2 text-sm font-medium text-white bg-gray-800	 rounded-lg border border-white-700 hover:bg-white-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-white-800">
					<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
					<span class="sr-only">Search</span>
				</button>
			</form> 		
				</div>				
				<div class="flex text-white pt-3 text-2xl px-20 mx-20  ">
