          ...
          <div class="flex shadow-md my-10">
            <div class="w-3/4 bg-white px-10 py-10">
              ...
              <div class="flex mt-10 mb-5">
                <h3 class="font-semibold text-gray-600 text-xs uppercase w-2/5">Thông tin chi tiết sản phẩm</h3>
                <h3 class="font-semibold text-center text-gray-600 text-xs uppercase w-1/5 text-center">Số lượng</h3>
                <h3 class="font-semibold text-center text-gray-600 text-xs uppercase w-1/5 text-center">Giá bán</h3>
                <h3 class="font-semibold text-center text-gray-600 text-xs uppercase w-1/5 text-center">Tổng cộng</h3>
              </div>
            ...
            <div id="summary" class="w-1/4 px-8 py-10">
              ...
              <div class="flex justify-between mt-10 mb-5">
                <span class="font-semibold text-sm uppercase">Sản Phẩm</span>
                <span class="font-semibold text-sm">4.000.000</span>
              </div>
              <div>
                <label class="font-medium inline-block mb-3 text-sm uppercase">Vận Chuyển</label>
                <select class="block p-2 text-gray-600 w-full text-sm">
                  <option>Giao Hàng Tiêu Chuẩn - 25.000</option>
                </select>
              </div>
              <div class="py-10">
                <label for="promo" class="font-semibold inline-block mb-3 text-sm uppercase">Mã giảm giá</label>
                <input type="text" id="promo" placeholder="Nhập mã giảm giá" class="p-2 text-sm w-full">
              </div>
              ...
              <div class="border-t mt-8">
                ...
                <button class="bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Đăng Ký</button>
              </div>
            </div>
